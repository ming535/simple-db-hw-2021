...
public class TupleDesc implements Serializable {
    ...
    public int fieldNameToIndex(String name) throws NoSuchElementException {
        ...
        if (idx == -1) {
            throw new NoSuchElementException("on such name");
        }
        return idx;
    }
    ...
    public static TupleDesc merge(TupleDesc td1, TupleDesc td2) {
        // some code goes here
        int numTuples = td1.numFields() + td2.numFields();

        Type[] typeAr = new Type[numTuples];
        String[] fieldAr = new String[numTuples];
